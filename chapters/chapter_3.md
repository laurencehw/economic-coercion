...
Manufacturing supply chain vulnerabilities do not fully capture the stakes, because food, energy, and water are existential: societies cannot function without them. Semiconductors can be stockpiled or substituted over months, but energy shortages take effect immediately, reducing heat, halting factories, and destabilizing governments.

Resource dependencies differ from manufacturing dependencies primarily in speed. Semiconductor shortages unfold over quarters as inventory depletes, whereas energy and food shortages produce cold homes, dark streets, and empty shelves within days. This immediacy makes resource coercion potent, because the target cannot wait it out or slowly build alternatives. Voters experience energy prices and food availability directly in ways they do not experience chip fabrication.
...
**Long-term restructuring** followed. Germany announced 13+ new LNG terminals and diversification of supply. Eastern European nations accelerated connections to non-Russian sources. The European Union's REPowerEU plan targeted rapid renewable deployment, efficiency improvements, and hydrogen development to eliminate Russian fossil fuel imports by 2027. Whether Europe maintains the political will to sustain these investments, and whether the transition proves economically sustainable, remains uncertain. The crisis nonetheless showed that Russia would sacrifice gas revenue for geopolitical gains, and that energy dependencies constrain the foreign-policy autonomy of importers.
...
As Chapter 2 detailed, China controls 85-90% of rare earth processing—a dominance built through decades of industrial policy, environmental externalization, and strategic patience (IEA 2023). The 2010 China-Japan Senkaku/Diaoyu crisis (analyzed in Chapter 9) demonstrated Beijing's willingness to weaponize this position: informal export restrictions through customs "inspections" disrupted Japanese manufacturers and forced a diplomatic capitulation. Japan's subsequent diversification—reducing Chinese rare earth import share from 95%+ to 50-60% over a decade—illustrates both the reality and the limits of resource coercion.
