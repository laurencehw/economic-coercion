...
This export concentration creates several vulnerabilities. The first is that weather and crop failures in major exporters trigger global shortages. Russia's 2010 drought and subsequent export ban caused wheat prices to spike 50%, contributing to the Arab Spring unrest. U.S. droughts in 2012 pushed corn prices to record highs, straining livestock producers globally and increasing food costs for consumers. As climate change increases weather variability and extreme events become more frequent, these supply shocks will likely intensify.
...
Yemen, embroiled in civil war since 2015, imports approximately 90% of food (WFP 2024). The Saudi-led coalition's blockade of Yemeni ports has created the world's worst humanitarian crisis, with 80% of the population requiring humanitarian aid and millions facing famine. In civil conflict, control over ports and supply routes becomes control over the populations that depend on them.
