...
Chinese government responses to resource vulnerabilities are comprehensive. **Strategic reserves** encompass rare earths, copper, aluminum, soybeans, and even frozen pork—larger than Western counterparts relative to consumption. **Vertical integration** captures entire supply chains: rare earth processing (85%) through downstream magnets (90%) and phosphors (80%), and similarly for solar panels and batteries. The **dual circulation** strategy (introduced in Chapter 2) applies directly to resources: internal circulation means building domestic capacity despite higher costs; external circulation means diversifying so no single supplier holds leverage. **Technology substitution** pursues alternatives—EVs reducing oil dependence, renewables displacing coal, synthetic biology potentially replacing agricultural imports.

### Debates and Tensions

Internal Chinese debates mirror Western ones. **Efficiency versus security**: economists argue self-sufficiency reduces growth; security hawks counter that dependencies create unacceptable vulnerability. **Leverage versus vulnerability**: using rare earth leverage (2010, 2023) signals power but accelerates the diversification that erodes it. **Domestic costs**: food self-sufficiency requires inefficient agricultural subsidies; coal dependence means continued pollution; rare earth mining damages Inner Mongolia. Officials must balance resource security against welfare, environment, and climate commitments.
