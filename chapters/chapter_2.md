...
- Identify the four conditions that convert an ordinary supply-chain dependency into a strategic chokepoint, and distinguish genuine chokepoints (semiconductors, rare earths) from benign dependencies (coffee, bananas).
- Explain how the semiconductor value chain distributes leverage across design, EDA software, manufacturing equipment, fabrication, and materials, and why Taiwan's dominance in advanced fabrication is the single most acute point of failure in the global economy.
- Analyze how China came to dominate the midstream *processing* of rare earths and critical minerals, and evaluate the strategies—reshoring, friend-shoring, diversification, stockpiling, and substitution—proposed to reduce that dependence.
- Assess the coercive potential and real-world track record of supply-chain weapons, including China's 2023–2025 gallium, germanium, antimony, and rare-earth export controls.
- Apply the Chapter 1 framework (the four dimensions of coercion and the five effectiveness criteria) to the 2010 China–Japan rare earth episode and to contemporary chokepoint disputes.

## Executive Summary

In March 2020, as COVID-19 spread globally, American hospitals could not obtain N95 masks, ventilators, or testing supplies. The shortages stemmed not from insufficient American manufacturing capacity historically, but from a decades-long shift that had concentrated production of personal protective equipment overwhelmingly in China. The logic of globalization, in which each country specializes where it is most efficient and trades for the rest, had carried clear gains in the abstract; its strategic costs were less visible until they materialized. Within weeks, officials across the U.S. government began examining supply chain vulnerabilities they had previously discounted, including which other critical goods came predominantly from potential adversaries, whether these dependencies could be weaponized, and how quickly production could be reshored.

The pandemic confirmed what specialists had long warned: supply chains optimized for efficiency had created acute concentration risks in strategically critical sectors. Governments now confront chokepoints they had largely ignored for decades.

A chokepoint forms when four conditions converge: geographic or corporate concentration, technical difficulty of substitution, criticality to downstream industries, and years required to build alternatives. Semiconductors meet all four, since Taiwan's TSMC produces 90% of the world's advanced chips (SIA 2023). So do rare earths, where China processes roughly 90% of global supply (USGS 2025). The same holds for pharmaceutical ingredients, where a 2019 FDA facility census found only about 28% of the plants making active pharmaceutical ingredients for the U.S. market were domestic, the rest spread across Europe, India, China, and elsewhere (FDA 2019), and for critical minerals for the energy transition, where China dominates lithium, cobalt, and graphite processing despite not controlling the mines.

These chokepoints did not emerge through comparative advantage alone. Specific industrial policies created them, environmental externalization accelerated them, and just-in-time manufacturing locked them in. China's rare earth dominance reflects deliberate government support combined with Western firms willing to offshore environmentally damaging processing, and Taiwan's semiconductor leadership stems from large TSMC investments backed by government incentives. Because these dependencies were built by policy over many years, policy cannot easily reverse them.

Every proposed remedy involves substantial tradeoffs. Reshoring semiconductor fabrication requires tens of billions in subsidies and a decade to achieve meaningful scale. Friend-shoring offers limited relief because allies often face the same Chinese dependencies. Diversification reduces single-point-of-failure risks but cannot eliminate exposure to a dominant supplier. None of these approaches is costless.

A state that controls these chokepoints can impose serious economic costs on an adversary without resorting to military force. This recognition is driving the most significant restructuring of global supply chains since the end of the Cold War, a transformation that will shape which countries can sustain advanced manufacturing, deploy next-generation technologies, and maintain military capabilities in crisis.

---

## The Geography of Supply Chain Chokepoints

### The Four Conditions for a Chokepoint
...
{% hint style="info" %}
**Defining a Strategic Chokepoint**
A strategic chokepoint exists when four conditions converge: geographic or corporate concentration of production, technical difficulty of substitution, criticality to downstream industries, and extended time required to build alternative capacity. Unlike ordinary trade dependencies such as coffee or bananas, strategic chokepoints create exploitable vulnerabilities where disruption or denial can cripple entire economic sectors or military capabilities.
{% endhint %}

The first condition is geographic or corporate concentration. Production must be concentrated in a small number of locations or firms, such that disruption or denial affects a large share of global supply. Taiwan's TSMC manufactures approximately 90% of the world's most advanced semiconductors (chips at 5 nanometer nodes and below) (Khan, Mann, and Peterson 2021; Miller 2022). China refines roughly 90% of the world's rare earth elements and mines about 70% of the raw ore (U.S. Geological Survey 2025). The Netherlands' ASML (Advanced Semiconductor Materials Lithography) is the sole manufacturer of extreme ultraviolet (EUV) lithography machines essential for producing cutting-edge chips. This concentration means that disruption, whether from geopolitical crisis, natural disaster, or deliberate restriction, cannot easily be compensated by ramping up production elsewhere.

The second condition, difficulty of substitution, amplifies the strategic significance of concentration. Some concentrated production can be rapidly replaced if interrupted. Other production faces technical barriers, large capital requirements, or long lead times that make substitution infeasible in the short to medium term. Building a semiconductor fabrication facility capable of producing advanced chips requires $15-20 billion in capital investment and 3-5 years of construction and testing (Khan, Mann, and Peterson 2021). Developing rare earth processing capacity involves not only mining but also complex chemical separation processes that take years to establish and generate substantial environmental hazards. These barriers to entry mean that even wealthy countries with strong technical capabilities cannot quickly reduce dependencies when geopolitical circumstances change.

The third condition, criticality to downstream industries, determines whether concentration matters strategically. A chokepoint is most consequential when the concentrated input is essential to sectors vital for economic competitiveness, national security, or public health. Semiconductors are critical because they power everything from smartphones to data centers to advanced weapons systems, and no modern economy or military can function without reliable access to chips. Rare earth elements are critical because they are essential for permanent magnets in wind turbines, electric vehicle motors, and precision-guided munitions. Active pharmaceutical ingredients are critical because drug shortages can trigger public health crises. Inputs that are concentrated but not critical to strategic sectors, such as certain consumer goods, pose less leverage.

The fourth condition, the time required to build alternative capacity, distinguishes strategic chokepoints from ordinary dependencies. Even when substitution is theoretically possible, the time required to develop alternative sources determines vulnerability during crises. If alternative capacity can be built in months, dependencies are manageable through strategic stockpiles and emergency measures. When alternative capacity requires a decade, dependencies create sustained vulnerabilities that can be exploited for coercive leverage. The U.S. CHIPS Act, passed in 2022, provides $52 billion in subsidies to rebuild domestic semiconductor manufacturing (Rasser et al. 2022), but even with this investment, substantial production will not come online until the late 2020s or 2030s. This extended timeline means that Taiwan's current dominance will persist for years regardless of reshoring efforts.
...
Figure 2.1 puts that division of labor on a map. What the exercise clarifies is how few places are involved: the chokepoints are not broad industrial regions but a short list of named facilities, several of them within artillery range of contested water.
...
Approximately 90% of the world's most advanced semiconductors (5nm and below) are manufactured by a single company (TSMC) on an island (Taiwan) that China claims as its territory and has not ruled out seizing by force. A natural disaster, military conflict, or blockade affecting Taiwan would immediately cripple global technology sectors, from smartphones and data centers to advanced weapons systems and medical equipment.
{% endhint %}
...
**Rare earth elements and critical minerals** present a different type of chokepoint—one where China's dominance stems primarily from processing rather than geological monopoly. Rare earth elements (a group of 17 elements including neodymium, dysprosium, and europium) are essential for permanent magnets used in wind turbines, electric vehicle motors, computer hard drives, and military applications from F-35 fighter jet engines to precision-guided missiles. China mines approximately 70% of global rare earth ore, but more critically, processes roughly 85-90% of the world's rare earths into usable forms (USGS 2025). This processing dominance developed over decades as Western firms offshored environmentally damaging refining operations, and Chinese state-backed companies consolidated market share through vertical integration and subsidies.

Beyond rare earths, China's dominance extends to other minerals critical for the energy transition. China controls approximately 60% of lithium processing (despite Australia and Chile leading in mining), 80% of cobalt refining (though the Democratic Republic of Congo produces 70% of ore), and 80% of natural graphite processing (a critical battery component) (IEA 2022; Benchmark Mineral Intelligence 2023). The pattern is consistent: China does not monopolize raw material extraction but dominates the midstream processing that converts ore into materials usable in batteries, magnets, and electronics.
...
**Pharmaceutical ingredients** constitute a third critical chokepoint, one dramatically exposed by the COVID-19 pandemic. No single reliable figure captures overall U.S. dependence, and the widely repeated claim that China and India together supply "80% of APIs" is unsupported: it conflates facility counts with production volume and traces to no primary source. The most authoritative available data are facility counts. A 2019 FDA census found that only 28% of the plants making active pharmaceutical ingredients (APIs) for the U.S. market were domestic, with the remainder in Europe (~26%), India (~18%), China (~13%), and other countries (~15%) (FDA 2019). India leads in finished-generic *volume*; China's leverage is concentrated further upstream, in the precursor chemicals and key starting materials that feed both Indian and domestic API production. Dependence appears especially acute for antibiotics and their precursors, which are heavily concentrated in China, though reliable volume shares are not publicly published (U.S. Pharmacopeia, *Medicine Supply Map*, 2023). For some individual generic drugs, single-country dependence approaches 100%. This concentration developed gradually as American and European pharmaceutical companies pursued cost savings by offshoring API production to countries with lower labor costs and less stringent environmental regulations, accelerating after China's 2001 WTO accession.

{% hint style="warning" %}
**Pharmaceutical API Concentration: A Hidden National Security Vulnerability**
Unlike semiconductor shortages that unfold over quarters, pharmaceutical supply disruptions can create immediate public health crises. Hospitals typically maintain only days to weeks of medication inventory, meaning API cutoffs translate rapidly into empty pharmacy shelves and treatment interruptions. The 2020 Indian export restrictions on hydroxychloroquine demonstrated how quickly pharmaceutical nationalism can cascade into shortages affecting millions of patients.
{% endhint %}

The strategic implications became apparent during COVID-19 when shortages emerged not only in personal protective equipment (N95 masks produced overwhelmingly in China) but also in pharmaceutical precursors, testing supplies, and even basic medications. China's export restrictions in early 2020, ostensibly for domestic health needs, raised fears about deliberate leverage, fears that intensified when Chinese government officials suggested restricting pharmaceutical exports to the U.S. as retaliation for other disputes. Even absent deliberate weaponization, quality control concerns have emerged repeatedly: the 2008 heparin contamination incident that caused deaths in the U.S. traced to Chinese suppliers, and fentanyl precursors that fuel America's opioid epidemic come predominantly from Chinese chemical manufacturers.

**Battery production and energy transition materials** increasingly create chokepoints as the global economy shifts toward electric vehicles and renewable energy. China manufactures roughly 80% of the world's lithium-ion battery cells and controls even larger shares of upstream components: about 85% of anodes (typically made from graphite) and 70% of cathodes (IEA 2024). Chinese firms like CATL (Contemporary Amperex Technology Co. Limited) and BYD dominate global battery markets, with CATL alone supplying batteries to Tesla, BMW, Volkswagen, and others. China's dominance of the solar supply chain is even more complete, and it deepens at every stage: China produces roughly 93% of the world's polysilicon, 97% of wafers, and 85% of finished modules (IEA 2024).
...
**Comparative advantage and specialization** represent the starting point. Basic economic theory suggests that countries and firms should specialize in activities where they have relative efficiency advantages, trading for other needs. Taiwan developed semiconductor manufacturing expertise through deliberate industrial policy (government support for TSMC's creation in 1987), substantial human capital investments, and geographic clustering in Hsinchu Science Park that enabled knowledge spillovers. Over time, TSMC's scale advantages—the enormous capital cost of each new fabrication facility, examined in the deep-dive below, together with the continuous R&D that leading-edge production demands—created barriers to entry that reinforced dominance. South Korea followed a similar path in memory chips, with Samsung and SK Hynix achieving scale that makes competing prohibitively expensive.
...
Taiwan's semiconductor success similarly involved deliberate government policy: the state financed TSMC's launch and recruited Morris Chang to run it, a founding story the deep-dive below tells in full. The Taiwanese government also provided tax incentives, infrastructure support, and R&D funding that enabled TSMC's early development. South Korea followed comparable policies supporting Samsung and SK Hynix through preferential financing, R&D support, and tolerance of corporate structures (chaebol conglomerates) that enabled sustained investment even during downturns.

The implication is significant: if chokepoints resulted from market forces alone, they might be reversed through market mechanisms (competitors entering when prices rise above costs). But when chokepoints reflect sustained government support, reversing them requires comparable or greater government intervention, which is costly and politically difficult, especially in market-oriented economies where industrial policy faces skepticism.
...
The logic was economically rational in stable geopolitical environments. Redundancy was hard to justify when disruptions were rare and brief, and maintaining expensive domestic capacity was hard to justify when offshore production cost 30-50% less. Firms made these decisions on cost grounds rather than strategic ones. The misalignment between corporate optimization, focused on shareholder returns and quarterly results, and national strategic needs, focused on resilience and security, is a central source of contemporary supply chain vulnerability. Shareholders demanded efficiency while nations needed resilience, and for roughly thirty years efficiency prevailed.

The COVID-19 pandemic undermined the assumptions underlying just-in-time optimization. When demand surged and borders closed, the absence of redundancy and inventory buffers created cascading shortages. The recognition that efficiency and resilience can conflict now drives reshoring debates. But translating this lesson into policy requires addressing the economic incentives that created concentrated supply chains in the first place, either through regulatory requirements (mandating redundancy despite costs) or subsidies (compensating firms for maintaining less efficient but more resilient supply chains). Both approaches face political and economic headwinds.
...
The most acute single chokepoint identified by American national security strategists is semiconductors, and specifically Taiwan's dominance in manufacturing the most advanced chips. Semiconductors are foundational to the modern economy: they power smartphones, data centers, artificial intelligence systems, autonomous vehicles, telecommunications networks, and virtually every advanced weapons system. An economy or military without access to cutting-edge chips operates at a sustained technological disadvantage. Yet roughly 90% of the world's most advanced semiconductors come from a single company (TSMC) on an island (Taiwan) that China claims as its territory and has not ruled out seizing by force. The strategic exposure this creates is difficult to overstate, since few other inputs combine comparable concentration with comparable criticality. Understanding this chokepoint, including how it developed, why it persists, and what responses are being attempted, is essential for grasping contemporary economic security challenges.
...
**Design** is the first stage, where companies conceive new chips and translate requirements into detailed specifications. This stage is dominated by American firms: Intel designs and manufactures its own chips (an integrated model), while "fabless" companies like AMD, Nvidia, Qualcomm, Broadcom, and Apple design chips but outsource manufacturing to specialized foundries. Britain's ARM (majority-owned by Japan's SoftBank since 2016; returned to public markets via a Nasdaq IPO in September 2023, with SoftBank retaining roughly 90% of shares) licenses chip architectures used in virtually all smartphones. Chinese firms, particularly Huawei's HiSilicon division before U.S. sanctions, also design chips but depend on foreign manufacturing. Design requires sophisticated software tools—Electronic Design Automation (EDA) software—dominated by three firms that together hold roughly three-quarters of the market: Synopsys and Cadence (both American) and Siemens EDA, the former Mentor Graphics, German-owned since Siemens acquired it in 2017 and rebranded it in 2021 (TrendForce 2024). At the leading edge (advanced nodes of 7nm and below) the trio's combined share is higher still. Because two of the three vendors are American and the third depends on U.S.-origin technology, this concentration gives Washington extraordinary leverage: denying access to EDA tools effectively prevents sophisticated chip design, as China discovered when U.S. export controls cut HiSilicon off from software updates.

**Manufacturing equipment** is the next critical stage. Producing modern semiconductors requires hundreds of specialized machines, each costing tens of millions of dollars, arranged in extraordinarily precise sequences. The United States maintains strength in several categories: Applied Materials, Lam Research, and KLA Corporation dominate deposition equipment (laying down thin films of materials), etching equipment (removing material to create circuit patterns), and inspection equipment (checking for defects). But the most critical chokepoint belongs to the Netherlands: ASML is the sole manufacturer of extreme ultraviolet (EUV) lithography machines, which use light with wavelengths just 13.5 nanometers to etch transistor features smaller than viruses onto silicon wafers. Each EUV machine costs approximately $150 million, requires three Boeing 747s to ship, and represents the leading edge of optical engineering (Miller 2022; ASML 2023), relying on mirrors polished to atomic-scale smoothness and lasers generating 50,000 pulses per second to vaporize tin droplets and produce EUV light. No other company has successfully produced EUV lithography, and without it, manufacturing chips at 7nm, 5nm, or 3nm nodes (the leading edge) is impossible. Japan also maintains significant equipment strength through Tokyo Electron (etching and coating equipment) and Screen Holdings (cleaning equipment).

This equipment concentration creates extraordinary leverage. The 2019-2022 U.S. campaign to prevent ASML from selling EUV machines to China's SMIC (Semiconductor Manufacturing International Corporation) exemplifies this leverage in action. After years of diplomatic pressure on the Dutch government, ASML has not delivered EUV machines to any Chinese customer, effectively capping Chinese chip manufacturing at 7nm nodes without EUV-enabled production. (Chapter 4 examines the October 2022 export controls that broadened these restrictions, and Chapter 6 details the legal architecture of export control authorities.)

**Fabrication** is where silicon wafers become functioning chips—and where Taiwan's dominance creates the most acute vulnerability. TSMC holds approximately 54% of the global foundry market by revenue (outsourced chip manufacturing) (TechInsights 2023), but more critically, produces roughly 90% of the world's most advanced chips at 5nm nodes and below (Khan, Mann, and Peterson 2021; Miller 2022). South Korea's Samsung has approximately 16% of the foundry market and can produce at leading-edge nodes, though it typically trails TSMC by 1-2 years in introducing each new process generation and has faced yield challenges (the percentage of chips that function correctly). Intel, historically dominant in semiconductor manufacturing, has struggled in recent years, falling behind TSMC's process technology—a failure that prompted the Intel board to replace CEO Bob Swan with Pat Gelsinger in February 2021 (Intel press release, January 13, 2021; *Wall Street Journal*, January 13, 2021) and led to Intel's new strategy of becoming a foundry for other companies' designs (Intel Foundry Services, launched March 2021). Gelsinger's costly turnaround fell short of its milestones: he was ousted in December 2024, and in March 2025 the board named Lip-Bu Tan—former CEO of the EDA firm Cadence—to lead the revival (Intel 2025). China's SMIC can produce at 14nm and, reportedly, 7nm through multi-patterning techniques that don't require EUV, but faces yield challenges, much higher costs than TSMC, and cannot approach 5nm or 3nm.

Fabrication concentration creates several vulnerabilities. The first is geographic: TSMC's most advanced fabs cluster in Taiwan's Hsinchu Science Park and Tainan Science Park, so an earthquake (Taiwan sits on the Pacific Ring of Fire), cross-strait military conflict, or Chinese blockade could disrupt production that supplies Apple, AMD, Nvidia, Qualcomm, and virtually every other designer of high-performance chips. The second is corporate: while other foundries exist, none can produce leading-edge chips at scale, and qualifying chips on a new manufacturing process takes 12-24 months of engineering work (Kleinhans and Baisakova 2020), so chip designers cannot easily switch foundries if TSMC faces disruption. The third is water dependency: semiconductor fabrication requires enormous quantities of ultrapure water (a single fab may consume 20-30 million gallons daily; Miller 2022), and Taiwan has faced severe droughts that forced water rationing, a problem that climate change threatens to intensify.

**Assembly, testing, and packaging** is the final stage, where fabricated chips are cut from wafers, packaged to protect delicate circuits, tested for functionality, and prepared for integration into devices. This stage is less concentrated than fabrication but still regionally clustered: Taiwan, China, Malaysia, South Korea, and to a lesser extent the Philippines and Vietnam dominate. China holds approximately 38% of global back-end capacity, reflecting lower labor costs and proximity to electronics manufacturing (Kleinhans and Baisakova 2020). This stage generally involves less sophisticated technology than fabrication (though advanced packaging is becoming increasingly important), and thus poses less acute strategic risk—but it still creates dependencies, particularly for China's ability to deny assembly services.

**Materials and gases** complete the supply chain. Semiconductor manufacturing requires exotic materials in extreme purity: photoresists (light-sensitive chemicals used in lithography, dominated by Japanese firms JSR, Tokyo Ohka Kogyo, and Shin-Etsu Chemical), silicon wafers (Japan's Shin-Etsu and SUMCO with a combined 50%+ global market share; Kleinhans and Baisakova 2020), ultra-high-purity gases (neon, krypton, xenon—notably, neon supplies faced disruption when Russia invaded Ukraine in 2022, as Ukraine had supplied an estimated half of the world's semiconductor-grade neon), and specialty chemicals. Japan's strength in materials reflects decades of accumulated expertise and extreme quality control—producing photoresist with one impurity per trillion requires mastery that new entrants struggle to match.

This complexity means that no single country can produce advanced semiconductors without reliance on others. The United States dominates design and much equipment. The Netherlands holds a unique chokepoint in EUV lithography. Japan excels in materials and some equipment. Taiwan leads in fabrication. South Korea maintains significant memory chip production (SK Hynix and Samsung together control approximately 70% of DRAM memory and 50% of NAND flash memory markets) (TechInsights 2023). China has substantial assembly capacity but depends on others for design, equipment, advanced fabrication, and materials. This interdependence means that semiconductor statecraft requires allied coordination—unilateral American controls have limits when targets can potentially access Dutch equipment or Japanese materials. It also means that semiconductor supply chains cannot easily be "reshored" to any single country; the realistic goal is "friend-shoring" that maintains specialization among allied nations while reducing exposure to strategic competitors.
...
Today TSMC manufactures chips for Apple (A-series and M-series processors), AMD (Ryzen CPUs and Radeon GPUs), Nvidia (graphics processors and AI accelerators), Qualcomm (smartphone processors), MediaTek, and hundreds of other customers. The company holds approximately 54% of the global foundry market by revenue, but this understates its strategic importance. Where TSMC's dominance becomes absolute is at the leading edge. Of chips manufactured at 5nm nodes (transistors with features roughly 5 nanometers wide), TSMC produces approximately 90%. At 3nm, TSMC and Samsung both produce commercially—Samsung actually reached 3nm volume production first, in June 2022, using a gate-all-around (GAA) transistor architecture, some months ahead of TSMC's December 2022 3nm ramp—but Samsung's persistent yield problems and thin customer base mean TSMC still captures the overwhelming majority of leading-edge output. By 2026 the true frontier has moved to the 2nm class: TSMC's N2 entered volume production in 2025 and Intel's competing 18A process began ramping, with TSMC again holding a commanding lead. The upshot is that virtually all high-performance processors for smartphones, data centers, AI training, and advanced computing still depend on Taiwanese fabrication.

This dominance has gone unchallenged for four reasons: capital intensity, accumulated expertise, ecosystem lock-in, and government support.

**Capital intensity** creates enormous barriers to entry. Each new generation of semiconductor fabrication requires approximately $15-20 billion for a single fab capable of volume production. TSMC operates dozens of fabs, with capital expenditure of $35-40 billion annually in recent years (TSMC annual reports). Building a competing foundry network requires hundreds of billions—sums that only governments can realistically provide, and even then only with sustained commitment across multiple election cycles. Intel's struggles illustrate the challenge: despite being an incumbent with deep expertise, Intel's attempt to match TSMC's process technology has consumed tens of billions and still lags by critical years. For new entrants without Intel's existing capabilities, the challenge is even more daunting.
...
**Government support** provided crucial early advantages and continues to shape TSMC's trajectory. The Taiwanese government, through its national development fund, provided 48% of TSMC's initial capital, recruited Morris Chang to lead the venture, and provided tax incentives and infrastructure support. Taiwan's Industrial Technology Research Institute (ITRI) conducts pre-competitive R&D that benefits TSMC. The government ensures stable electricity and water supply despite Taiwan's resource constraints (semiconductor fabs have priority during droughts). Critically, Taiwan has made semiconductor leadership a national priority: TSMC is understood as essential to Taiwan's security (its importance to the global economy makes Chinese aggression less likely by raising international costs of disruption) and its economic competitiveness.

These factors interact to create a sustained competitive advantage that subsidy programs elsewhere struggle to overcome. The U.S. CHIPS Act ($52 billion) has induced TSMC to build fabs in Arizona, but these will trail Taiwan's leading-edge production by 1-2 generations and face 30-50% higher operating costs (due to more expensive labor, energy, and construction; estimates vary from 10-20% above Taiwanese costs (TechInsights 2023) to 50% (Chang 2021)). European programs similarly aim to attract semiconductor investment, but face the reality that Taiwan's lead reflects decades of accumulated advantages that cannot be quickly replicated.
...
The **CHIPS and Science Act**, signed into law in August 2022, provides $52 billion in subsidies for semiconductor manufacturing and R&D in the United States. The legislation includes $39 billion in manufacturing incentives, $11 billion for R&D (including the National Semiconductor Technology Center for advancing chip technology), and $2 billion for defense and legacy chips. These subsidies aim to reverse decades of manufacturing decline: U.S. share of global semiconductor fabrication fell from 37% in 1990 to just 12% in 2020 (SIA 2021), reflecting offshoring to Taiwan, South Korea, and elsewhere where governments provided more support and costs were lower.

CHIPS Act incentives have already induced substantial announced investments—and TSMC's Arizona commitment has ballooned. What began as a $12 billion single-fab project grew to $65 billion across three fabs by 2024, and in March 2025 TSMC raised its total pledge to $165 billion (three fabrication plants plus two advanced-packaging facilities and an R&D center)—the largest single foreign direct investment in U.S. history (TSMC 2025). The first Arizona fab reached volume production of 4nm chips in late 2024, supplying customers including Apple and Nvidia. Samsung is expanding in Texas with $17 billion investment. Intel announced $20 billion for Ohio facilities and tens of billions more for Arizona expansion, as part of then-CEO Pat Gelsinger's strategy to restore Intel's manufacturing competitiveness and build a credible foundry business serving external customers (Intel's Ohio timeline has since slipped). Micron, SK Hynix, and others have also announced U.S. investments, together bringing more than $200 billion in new domestic semiconductor facilities (SIA 2023).

Yet even these massive investments face limitations. The first is timescale: new fabs take 3-5 years to construct and ramp to volume production, so substantial new capacity will not come online until the late 2020s. The second is cost: manufacturing in the U.S. costs 30-50% more than in Taiwan or South Korea due to higher labor, energy, and construction costs (SIA 2021; Department of Commerce 2023). Subsidies offset these disadvantages partially but not entirely, and they must be sustained over decades to maintain competitiveness. The third is talent: semiconductor manufacturing requires tens of thousands of engineers and technicians with specialized expertise, and American universities have not produced these cohorts in decades. TSMC's Arizona fabs have imported hundreds of Taiwanese engineers to provide expertise, raising questions about whether U.S. facilities will truly be independent of Taiwan. The fourth is ecosystem gaps: manufacturing requires not only fabs but also suppliers of equipment, materials, and components, many of whom lack a U.S. presence and may not build one unless demand justifies the investment.
...
**Export controls** represent the second pillar of U.S. strategy. Rather than retell the October 2022 controls—narrated in Chapter 1's opening vignette and dissected in detail in Chapter 4, with successive rounds in 2023 and 2024 tightening them further—this section concentrates on their strategic logic.
...
The strategy involves substantial risk. China may eventually develop indigenous equipment and EDA tools that, while inferior to Western technology, enable acceptable chip production; it has invested $100+ billion through its "Big Fund" (国家集成电路产业投资基金, National Integrated Circuit Industry Investment Fund) and designated semiconductors as a top national priority, and with sufficient time, perhaps a decade or more, Chinese firms may achieve adequate if not leading-edge capabilities. Aggressive export controls may also accelerate Chinese determination to achieve self-sufficiency at any cost, strengthening those in Beijing who argue that economic interdependence with the West is a vulnerability rather than an asset. Finally, controls risk fracturing allied coordination if European and Asian partners perceive U.S. restrictions as damaging their economic interests without proportionate security benefits.
...
China's approach involves massive state investment through the Big Fund (国家集成电路产业投资基金), now in its third phase with cumulative commitments exceeding $100 billion across all phases: approximately $21 billion (2014-2018), $29 billion (2019-2024), and $47.5 billion (announced May 2024) (Reuters 2024; SCMP 2024). These funds support Chinese chip manufacturers (SMIC, Hua Hong Semiconductor), equipment makers (AMEC, Naura Technology), materials suppliers, and design firms. The goal is vertical integration: developing Chinese capabilities across the entire semiconductor value chain to eliminate or reduce dependence on foreign suppliers at each stage.
...
The U.S.-China semiconductor competition is prolonged, expensive, and without a clear end. Washington aims to preserve its lead and prevent Chinese parity; Beijing seeks to reduce or eliminate dependence on foreign technology. Each side's strategies impose costs on the other, but neither can easily achieve decisive advantage. Both governments have made semiconductor supremacy a matter of national priority, which means neither will back down easily and both will sustain large expenditures. The likely result is continued partial decoupling: parallel semiconductor ecosystems that share some components (mature equipment, materials) while diverging in advanced manufacturing, with Taiwan caught in between and facing pressure from both sides to align. This partial decoupling will be economically costly (duplicating R&D, sacrificing scale economies) and strategically risky (each side racing to achieve advantages that might prove temporary). The dynamic is best understood not as inevitable American dominance or Chinese collapse but as a sustained competitive struggle with uncertain outcome, and realistic policymaking depends on grasping it as such.
...
**Nickel** rounds out the critical battery minerals. Indonesia has emerged as the overwhelmingly dominant nickel producer, supplying more than half of the world's mined nickel by 2023–2024 (up from roughly a third only a few years earlier), far ahead of the Philippines and Russia (USGS 2025). Nickel is essential for cathodes in lithium-ion batteries, particularly high-energy-density batteries for long-range electric vehicles. China again dominates refining: roughly 65% of nickel refining capacity is Chinese or Chinese-invested. Indonesia's nickel boom reflects Chinese investment in Indonesian smelters combined with Indonesia's 2020 ban on nickel ore exports, forcing miners to process domestically—a strategy directly modeled on China's approach of capturing value-added midstream processing rather than exporting raw materials.

### China's Rare Earth Dominance: How and Why

China's rare earth dominance resulted from concrete policy choices, not inevitable market forces. The United States dominated production from the 1950s through the 1980s via the Mountain Pass mine in California. The shift began as China opened the Bayan Obo mine in Inner Mongolia, and Chinese supply flooded markets while tightening U.S. environmental regulations (Clean Air Act, Clean Water Act, RCRA) raised domestic compliance costs. Mountain Pass closed in 2002—partly economic (Chinese competition), partly environmental (wastewater spills), partly strategic neglect. By the mid-2000s, China produced over 90% of global rare earths.

**Chinese industrial policy** deliberately consolidated this advantage through five strategies: consolidation of hundreds of firms into 6-8 state-owned champions; vertical integration into downstream applications (magnets, phosphors); export quotas encouraging foreign manufacturers to relocate processing to China; heavy R&D investment matching and exceeding Western capabilities; and strategic stockpiling. This model—identify strategic sectors, provide state support, control midstream processing, leverage market power—proved highly effective.

**Environmental externalization** was central to the competitive advantage and remains a major barrier to Western reshoring. Rare earth processing generates radioactive waste and toxic byproducts. In China, particularly during the 1990s-2010s, lax enforcement created cost advantages at the expense of severe local environmental damage (Baotou's radioactive slag heaps, polluted groundwater). Processing in compliance with Western environmental standards adds 30-50% to costs—creating a reshoring dilemma that requires either sustained subsidies or relaxed standards, neither politically easy.

### Western Responses: Mining, Diversification, and Substitution

Western initiatives to reduce reliance on Chinese processing have achieved modest progress but face substantial obstacles. **Mining investment** has reopened Mountain Pass (now producing ~15% of global rare earth ore via MP Materials) and expanded lithium projects in Australia, Argentina, and Chile—but most non-Chinese ore still ships to China for processing. Australia's Lynas operates the only significant non-Chinese rare earth processing facility (in Malaysia), supplying ~10% of global separated rare earths.

**Processing capacity development** is ultimately more critical than mining diversification. The U.S. Defense Production Act, Inflation Reduction Act, and EU Critical Raw Materials Act all fund domestic processing, but challenges persist: scale (China dwarfs Western facilities), expertise (accumulated knowledge takes years to build), environmental costs (communities resist hazardous processing facilities), and time (permitting and construction require 5-10 years minimum).
...
## Case Study 1: China's 2010 Rare Earth Restrictions Against Japan

**Background.** By 2010, China supplied roughly 95% of the world's rare earth elements and, more importantly, nearly all of the separated heavy rare earths and finished magnets on which advanced manufacturers depended. Japan—home to Toyota, Hitachi, Shin-Etsu, and a dense ecosystem of magnet, motor, and electronics producers—was the single largest importer, sourcing on the order of 90% of its rare earths from China (Wübbeke 2013). That dependence had been decades in the making, the product of the same environmental externalization and industrial consolidation that had shuttered Western processing and concentrated the industry in China. In the vocabulary of this chapter, it was a textbook chokepoint: concentrated, hard to substitute, critical to downstream industries, and slow to replace.

**The coercion event.** On 7 September 2010, a Chinese fishing trawler collided with two Japanese Coast Guard vessels near the disputed Senkaku/Diaoyu Islands in the East China Sea. Japan detained the trawler's captain, Zhan Qixiong, and announced it would prosecute him under Japanese law—an implicit assertion of sovereignty over the contested waters. Beijing demanded his immediate release, suspended high-level exchanges, and, according to Japanese trading houses and manufacturers, allowed customs and shipping frictions to bring rare earth exports to Japan to a near halt in late September. China never announced a formal embargo, and its officials denied that any measure targeting Japan existed—a studied ambiguity that is itself analytically important. Japan released the captain on 24 September; shipments reportedly resumed over the following weeks, though friction lingered into 2011.

**Mechanisms.** The episode illustrates coercion through a supply-chain chokepoint rather than tariffs, financial sanctions, or military force. The instrument was the denial (or threatened denial) of an input for which no near-term substitute existed, exploiting a dependence that had accreted through market forces and policy over decades. Crucially, the coercion operated largely through expectations: the mere demonstration that Beijing *could* interrupt supply—executed through opaque administrative means that preserved deniability—was enough to shock prices and galvanize buyers. Rare earth prices spiked several-fold over the following year, and "rare earths" entered the strategic vocabulary of every industrial ministry in the OECD.

**Outcome.** The immediate objective—securing the captain's release—was achieved, and the case is often cited as a successful use of economic leverage. Yet the medium-term results cut the other way, and that reversal is the episode's central lesson. First, the disruption's real economic bite was far smaller than the headlines implied: firms drew down inventories, substituted and "thrifted" their use of rare earths, and Chinese material kept reaching Japan through third countries and smuggling, which by some estimates accounted for 15–30% of Chinese exports (Gholz 2014). Whether a comprehensive embargo ever truly occurred remains contested (King and Armstrong 2013; Johnston 2013). Second, and more durably, the shock triggered exactly the diversification that the *substitution margin* predicts. Japan's government and firms invested in Australia's Lynas—whose Malaysian plant became the largest non-Chinese source of separated rare earths—built strategic stockpiles, funded recycling and rare-earth-reduction research, and signed alternative supply agreements. Within roughly five years Japan had cut its dependence on Chinese rare earths from about 90% to under 60% (Japanese government and industry figures). Third, the United States, the EU, and Japan challenged China's export quotas and duties at the WTO (DS431/432/433, filed March 2012); the panel and Appellate Body ruled against China in 2014, and Beijing removed the quotas in 2015.

**Assessment against the framework.** Scored against Chapter 1's five effectiveness criteria, the 2010 episode is a cautionary tale about mistaking a tactical win for strategic success. It rated well on *speed* and *goal achievement*—the captain was freed within weeks—but poorly on *durability* and *cost to the coercer*. The coercion advertised a vulnerability, and the target moved to close it, eroding the very leverage that made the threat credible: the classic "use it and lose it" dynamic. It also imposed *coalitional* costs, uniting China's largest customers in a common diversification and legal effort—activity along the coalitional margin that the book's two-margins thesis flags as the predictable second-order response to coercion. For fifteen years this outcome underwrote a widespread judgment that China's rare earth "weapon" was more bark than bite. As the perspective box that follows makes clear, Beijing appears to have drawn the opposite lesson—that the 2010 restrictions were too blunt and too easily circumvented—and has since rebuilt its leverage through a far more granular, legally institutionalized licensing architecture aimed at the heavy rare earths and magnets where substitution remains hardest.
...
Estimating overall U.S. dependence precisely is difficult, and the frequently cited claim that China and India together supply "80% of APIs" is unsupported—it conflates facility counts with production volume and has no reliable primary source. What the data do show is heavy reliance on foreign manufacturing: as detailed below, a 2019 FDA census found that barely a quarter of the API plants serving the U.S. market were domestic. Antibiotics and their precursor chemicals appear particularly concentrated in China, though reliable volume shares are not publicly published. Common medications for blood pressure (enalapril, valsartan), cholesterol (atorvastatin), diabetes (metformin), and other chronic conditions rely heavily on APIs manufactured in China and India. Generic drugs—which account for 90% of prescriptions in the U.S.—are particularly dependent on foreign APIs, as generic manufacturers compete primarily on price and thus source ingredients wherever costs are lowest.
...
By the 2010s, American API manufacturing had largely disappeared. A 2019 FDA report found that only 28% of facilities manufacturing APIs for U.S. drugs were located in the United States, down from over 50% in the 1970s. China hosted approximately 13% of API manufacturing sites, India 18%, and other foreign countries 41%. These figures likely understate dependence: many APIs notionally manufactured in other countries use precursor chemicals sourced from China. The full supply chain often involves Chinese precursors shipped to India for intermediate processing, then to the U.S. for final formulation, with each step creating a potential disruption point.

**National security implications** are substantial. The most immediate concern is supply reliability: if China or India restrict API exports, whether due to domestic shortages, retaliation for other policies, or deliberate leverage, U.S. pharmaceutical supplies could be disrupted within weeks or months. Hospitals and pharmacies typically maintain minimal inventory, days to weeks rather than months, so API disruptions quickly cascade to patient-level shortages. Quality control is a related concern, since APIs manufactured abroad face less stringent inspection than domestic production. The FDA conducts foreign inspections less frequently than domestic ones, and Chinese and Indian regulators' standards may not match FDA rigor. Several contamination incidents illustrate these risks, including the 2008 heparin contamination traced to Chinese suppliers that caused deaths in the U.S. and repeated failures of Indian generic manufacturers to meet quality standards.

A more remote concern is deliberate contamination. No confirmed cases exist, but the possibility that a foreign adversary controls production of essential medications raises the prospect of biological or chemical harm through pharmaceutical supply chains. Even absent deliberate contamination, denials of supply during crises could cripple medical systems. The pandemic exposed how quickly pharmaceutical supply chains seize during global health emergencies: when China imposed export restrictions on personal protective equipment and restricted API exports in early 2020, American hospitals and manufacturers faced immediate shortages. Chinese officials explicitly suggested restricting pharmaceutical exports as leverage, though Beijing ultimately did not follow through comprehensively.

### COVID-19 and PPE Shortages

The COVID-19 pandemic transformed abstract supply chain concerns into concrete crises. In February-April 2020, American hospitals faced shortages of N95 respirators, ventilators, testing supplies, and medications—all stemming from production concentration in China. Beijing implemented export restrictions on PPE to secure domestic supply, the Strategic National Stockpile was depleted by March 2020, and India restricted pharmaceutical exports, causing shortages of hydroxychloroquine and other drugs.

The geopolitical dimension was revealing: China engaged in "mask diplomacy" to project influence, the U.S. invoked the Defense Production Act to redirect domestic production, and European countries diverted shipments intended for other nations. The episode demonstrated both the fragility of just-in-time supply chains under surge demand and the willingness of states—including allies—to prioritize domestic needs over international commitments.

### Reshoring Challenges

Pharmaceutical reshoring faces the same cost-security tradeoffs as semiconductor reshoring: API manufacturing in the U.S. costs 30-50% more than in China or India, environmental regulations raise compliance costs, and decades of offshoring have atrophied the domestic skilled workforce. FDA approval timelines (18-36 months for new facilities) add further delay.

The realistic outcome is a hybrid approach: modest reshoring of truly critical medications, expanded strategic stockpiling, and continued foreign dependence for the bulk of generic drugs where cost considerations dominate. As with other supply chains, the goal is resilience through redundancy rather than full independence, accepting some vulnerability as the price of affordable medications.
...
Reshoring means bringing production back to the home country, eliminating foreign dependencies and preserving industrial capabilities. The strategic logic is compelling: domestic production cannot be disrupted by foreign government decisions or geopolitical crises, and quality control is easier under domestic jurisdiction.

The obstacles are primarily economic. Building semiconductor fabs demands the multibillion-dollar outlays and multi-year construction timelines examined earlier in this chapter; API manufacturing costs 30-50% more domestically; rare earth processing requires accepting environmental costs communities have resisted. The CHIPS and Science Act ($52 billion) represents the most ambitious reshoring effort, yet even optimistic projections suggest domestic facilities will produce only 15-20% of U.S. semiconductor consumption by 2030. TSMC's Arizona fabs face significant cost disadvantages versus Taiwan, construction delays, and workforce challenges. Pharmaceutical and rare earth reshoring have seen even more limited progress.

The realistic outcome is partial reshoring of the most critical inputs—advanced semiconductors for defense and AI, essential medications with no substitutes, rare earth processing for military applications—while accepting continued dependence where cost considerations dominate.

### Friend-shoring (Ally-shoring)

{% hint style="success" %}
**Friend-shoring vs. Near-shoring vs. Reshoring: Understanding the Terms**
**Reshoring** (onshoring) brings production back to the home country entirely. **Near-shoring** moves production to geographically proximate countries (e.g., Mexico for U.S. firms). **Friend-shoring** (ally-shoring) prioritizes supply chain relocation to geopolitically aligned nations regardless of geography. Each strategy involves different tradeoffs: reshoring maximizes control but costs most; near-shoring balances proximity and cost; friend-shoring leverages allied capabilities while accepting some geographic vulnerability.
{% endhint %}

Friend-shoring involves shifting supply chains from potential adversaries to trusted allies: sourcing semiconductors from Taiwan or South Korea, rare earths from Australia, pharmaceuticals from India or Europe. The logic is balancing security and economics: allies provide more reliable supply while maintaining cost advantages and enabling specialization (U.S. chip design, Taiwanese manufacturing, Japanese materials, European equipment).

The challenges are coordination and shared vulnerabilities. Allies have their own economic interests and may resist restrictions on China trade. South Korea's semiconductor companies depend on Chinese customers; Taiwan's geographic vulnerability means friend-shoring there doesn't address invasion risk; free-rider problems persist as each ally prefers others bear the costs. Progress has been mixed: Japan and the Netherlands agreed to restrict semiconductor equipment exports to China, but only after extended U.S. pressure and with narrower scope than Washington preferred. South Korea and European countries remain reluctant.

The realistic outcome is selective friend-shoring on the most strategically sensitive technologies while maintaining diverse supply chains including China for less sensitive goods.

### Diversification

Diversification involves sourcing critical inputs from multiple countries rather than relying on a single source: lithium from Australia, Chile, and Argentina rather than any one country, or APIs from India, Europe, and China rather than China alone. This reduces single-point-of-failure risks while avoiding reshoring's high costs.

The key limitation is that apparent diversification can be illusory when multiple suppliers depend on common inputs. Lithium mining across three continents still requires Chinese-dominated processing. API manufacturing in India may use Chinese precursor chemicals. The semiconductor supply chain spans dozens of countries but has irreducible chokepoints (ASML's EUV lithography, TSMC's advanced fabrication). True diversification requires mapping entire supply chains, not just immediate suppliers—and for genuine chokepoints, diversification isn't currently possible at scale.

### Strategic Stockpiling

Strategic stockpiling maintains reserves of critical materials to buffer supply disruptions, modeled on the Strategic Petroleum Reserve. Stockpiles provide rapid availability during crises at lower cost than excess production capacity, and buy time to develop alternatives. Japan invested significantly in rare earth stockpiling after the 2010 China crisis; South Korea maintains reserves of key industrial inputs.

The fundamental limitation is that stockpiles provide finite buffers: six months of semiconductor reserves only help if disruptions are temporary, and rapidly obsolescing goods (semiconductors improve every 18-24 months) lose value in storage. The Strategic National Stockpile for medical supplies proved inadequate during COVID-19. The realistic outcome is selective stockpiling of goods that are critical, stable, and storable—rare earths, certain pharmaceuticals, critical minerals—providing insurance against short-term disruptions without substituting for longer-term supply diversification.

### Technology Substitution

Technology substitution develops alternatives that eliminate dependencies entirely—batteries without cobalt, magnets without rare earths, manufacturing processes using more common materials. If successful, substitution provides permanent solutions rather than merely diversifying or reshoring existing dependencies. LFP batteries have already succeeded in eliminating cobalt dependencies for many EVs; sodium-ion research aims to replace lithium in grid storage; RISC-V architectures seek to reduce dependence on ARM and x86 chip designs.

The challenges are uncertainty and time horizons. Breakthroughs may not materialize despite investment, and even successful ones require years to scale—solid-state batteries have been "five years away" for two decades. Alternatives often involve performance tradeoffs, and substitution can trigger counter-adaptation: developing rare-earth-free motors might prompt China to restrict other critical inputs. Substitution is a medium-to-long-term strategy (5-15 years) rather than a solution for near-term dependencies.

### Synthesis: Difficult Tradeoffs

None of these strategies provides complete solutions; each involves tradeoffs between security and economics, near-term and long-term, efficiency and resilience. The realistic approach combines all five in layered fashion: for advanced semiconductors, friend-shoring (TSMC Arizona) plus export controls, stockpiling of mature nodes, and long-term substitution; for rare earths, modest reshoring, diversified mining, stockpiling, and substitution research; for pharmaceuticals, selective reshoring of critical APIs combined with diversification and stockpiling.

The pattern is consistent: complete independence is neither achievable nor economically rational, but reduced dependence and maintained alternatives enhance resilience. Whether democratic political systems can sustain such commitment across multiple election cycles—withstanding industry pressure and resisting premature declarations of victory—remains the central political question.
...
Massive state investment through mechanisms like the **Big Fund** (国家集成电路产业投资基金, Guójiā Jíchéng Diànlù Chǎnyè Tóuzī Jījīn—National Integrated Circuit Industry Investment Fund) provides tens of billions in subsidies for semiconductor development. The fund's first phase, launched in September 2014, was capitalized at RMB 138.7 billion (about $21 billion); its second phase, established in October 2019, at RMB 204.15 billion (about $29 billion); and its third phase, registered on 24 May 2024, at RMB 344 billion (about $47.5 billion)—the single largest tranche since the program began and larger than the first two phases combined (Caixin 2024). These funds support Chinese chip manufacturers (SMIC, Hua Hong), equipment makers (AMEC, Naura), materials suppliers, and design firms. Subsidies cover capital investment, R&D, talent recruitment, and sustained operational losses while firms develop capabilities.
...
For years these tools looked largely symbolic, and it was long possible to argue that China had not comprehensively weaponized its rare earth or gallium dominance—precisely because doing so would accelerate diversification and harm Chinese exporters. That judgment no longer holds, and the reversal is the strongest confirming evidence in this chapter for the book's thesis about weaponized interdependence. Beginning in 2023, Beijing moved from signaling to sustained use. It placed gallium and germanium under export licensing in August 2023, added antimony and certain graphite items in 2024, and on 3 December 2024 imposed an outright ban on exports of gallium, germanium, and antimony to the United States—the first time China had singled out a single country for a hard cutoff of these materials. In April 2025 it went further, subjecting seven medium and heavy rare earths and their magnets (including samarium, dysprosium, and terbium) to case-by-case export licensing; in October 2025 it expanded the regime to five additional elements, related processing technology, and—most consequentially—products made anywhere in the world with Chinese-origin rare earths, an extraterritorial reach deliberately modeled on the U.S. foreign direct product rule (MOFCOM 2025; CSIS 2025). The resulting licensing backlog stranded shipments and forced production slowdowns at automakers and defense contractors in the United States, Europe, and Japan through mid-2025. Beijing agreed to suspend the October 2025 measures for one year at the Trump–Xi summit in Busan on 30 October 2025, but the April 2025 licensing framework remains in force. Far from symbolic, China's midstream processing dominance has become one of the most potent instruments of economic coercion examined in this book. (Chapters 4 and 6 trace the reciprocal U.S. export-control escalation and the 2025 tariff cycle that ran in parallel.)
...
This debate parallels discussions about Taiwan and whether building indigenous semiconductor capabilities makes Chinese military action against Taiwan more likely, by reducing dependence on TSMC, or less likely, by reducing the strategic importance of controlling Taiwan's fabs. The answer depends on how Chinese leaders weigh economic and military factors, which outsiders struggle to assess definitively.
...
Title III authority supported domestic production of essential medications and active pharmaceutical ingredients, including investments in sterile injectable drug production and antibiotic precursor manufacturing — targeting the pharmaceutical and API vulnerabilities examined earlier in this chapter.
...
4. **No processing mandate**: DFC can finance mines and refineries, but cannot guarantee that materials will be processed in Western-aligned facilities rather than shipped to China for refining (the persistent midstream processing gap discussed earlier, in "Critical Minerals and the Green Transition")
...
Supply chain dynamics evolve rapidly: policies change, new facilities open, technologies advance, and geopolitical tensions fluctuate. Effective analysis requires ongoing monitoring through multiple channels:
...
- **Strategic chokepoints require four converging conditions:** Geographic or corporate concentration, difficulty of substitution, criticality to downstream industries, and extended time to build alternatives must all be present for a supply chain dependency to create genuine coercive leverage. Ordinary trade dependencies (coffee, bananas) lack one or more of these characteristics and pose limited strategic risk.

- **Chokepoints are products of policy, not just markets:** Semiconductor concentration in Taiwan, rare earth processing dominance in China, and pharmaceutical API offshoring all resulted from deliberate industrial policies, environmental externalization, and just-in-time optimization -- not inevitable market forces. This means reversing them requires comparable or greater government intervention, not simply market corrections.

- **Taiwan's semiconductor dominance represents the most acute single-point-of-failure in the global economy:** TSMC manufactures roughly 90% of the world's most advanced chips, and no amount of near-term investment can replicate Taiwan's accumulated expertise, ecosystem lock-in, and scale advantages. The CHIPS Act will reduce absolute U.S. dependence but cannot eliminate Taiwan's centrality for at least a decade.

- **China's supply chain leverage is concentrated in midstream processing, not mining:** China dominates the refining and processing of rare earths, lithium, cobalt, and graphite -- even when raw materials are extracted elsewhere. Diversifying mining sources alone is insufficient; building refining capacity is far more capital-intensive and environmentally challenging.

- **Reshoring and friend-shoring involve painful and persistent trade-offs:** No proposed fix—reshoring, friend-shoring, diversification—is costless or complete. Each strategy creates its own political and economic complications, and all require sustained political will across election cycles.

- **Export controls create a strategic calibration dilemma:** Restrictions that are too aggressive may accelerate Chinese determination to achieve self-sufficiency, eventually succeeding despite enormous cost. Restrictions that are too weak may fail to prevent parity. Calibrating denial to maintain dependence without provoking a crash indigenous development program is extraordinarily difficult.

## Discussion Questions

1. TSMC's dominance in advanced semiconductor fabrication creates what some analysts call a "silicon shield" for Taiwan -- the idea that the island's economic indispensability deters Chinese military aggression. Evaluate this argument. Does semiconductor dependence genuinely deter conflict, or could it motivate Beijing to seize the source of its vulnerability?

2. The chapter identifies five factors that created contemporary supply chain chokepoints: comparative advantage, economies of scale, industrial policy, environmental externalization, and just-in-time optimization. Which of these factors presents the greatest obstacle to supply chain restructuring, and why?

3. China's critical minerals processing dominance developed partly because Western countries regulated away environmentally damaging refining operations. Should the United States and Europe relax environmental standards to reshore mineral processing, or accept higher costs and slower timelines to maintain environmental protections? How should policymakers weigh these trade-offs?

4. The CHIPS Act provides $52 billion for domestic semiconductor manufacturing, but reshored fabs face persistent cost disadvantages versus Asian facilities. Is this a sustainable model for supply chain security, or does it create permanent subsidy dependence? What happens when subsidies expire?

5. Allied coordination on semiconductor export controls requires balancing U.S. security imperatives against the commercial interests of the Netherlands (ASML), Japan (Tokyo Electron), and South Korea (Samsung, SK Hynix). How should alliance managers handle cases where allies' economic losses from cooperation significantly exceed their perceived security benefits?

---

> **Tabletop Exercise:** The tabletop exercise for this chapter — *Semiconductor Chokepoint Crisis* — can be found in **Appendix A: Tabletop Exercises**.
...
U.S. Geological Survey. *Mineral Commodity Summaries 2025*. Reston, VA: USGS, 2025. (Rare earths, gallium, germanium, nickel production and processing shares.)

China Ministry of Commerce (MOFCOM). Export-control announcements on gallium and germanium (Aug. 2023), antimony and graphite items (2024), the gallium/germanium/antimony ban on exports to the United States (Dec. 3, 2024), and rare-earth-related items (Announcement No. 18 of April 2025; Announcement No. 61 of October 2025).
...
International Energy Agency. *Solar PV Global Supply Chains* (special report, 2022; data updated 2024). Paris: IEA. (Polysilicon, wafer, cell, and module manufacturing shares.)

Center for Strategic and International Studies. Analyses of China's rare-earth and critical-mineral export controls, 2023–2025.
