...
- Distinguish the four core concepts of the field—geoeconomics, economic statecraft, weaponized interdependence, and economic coercion—and deploy each precisely rather than interchangeably.
- Explain the "weaponized interdependence" mechanism, showing how panopticon and chokepoint effects convert asymmetric network positions into coercive leverage.
- Apply the book's four-dimension framework (domain, target, objective, intensity) and its five effectiveness criteria to a real-world coercive episode.
- Analyze any coercive measure through the book's two margins—the *substitution margin* (how quickly a target can replace what is denied) and the *coalitional margin* (who bears the cost and whether they can change the policy in dispute).
- Identify the correct U.S. legal authority behind a given measure—distinguishing IEEPA/OFAC financial sanctions from ECRA/EAR export controls—and explain why the distinction matters.
- Articulate how Chinese policymakers perceive Western economic statecraft, and why accounting for that perception produces better policy than ignoring it.

## Executive Summary

In October 2022, the United States imposed sweeping export controls on China's semiconductor industry—an attempt, on an unprecedented scale, to use commercial restrictions to constrain a strategic rival's technological development. That the world's two largest economies now press their sharpest advantages through supply chains and licensing rules rather than troops and missiles marks the arrival of a new era: the deliberate weaponization of economic interdependence itself.

This is the era of geoeconomics, in which the line between commercial exchange and strategic conflict has largely dissolved. For three decades, Western policymakers treated trade with rivals as a force for peace, on the assumption that commerce would dull the appetite for confrontation. That assumption has not held. Trade relationships, supply chains, technology standards, and financial flows have themselves become instruments of statecraft, and economic coercion—the use of economic measures to compel changes in another state's behavior—has moved to the center of great power competition. Understanding how it works is no longer optional for policymakers, business leaders, or the citizens caught up in these shifts.
...
The stakes extend well beyond academic interest. How the United States and China manage their interdependence while competing strategically may determine whether this century sees a managed rivalry or a far more dangerous one. In the worst case, a dispute over memory chips could escalate into military conflict over Taiwan; handled well, the same competition might be confined to domains where the costs are commercial rather than measured in lives. Understanding the tools, limits, and logic of economic coercion is essential to that task.
...
In October 2022, the United States attempted something with few precedents in the history of trade policy: to arrest a rival superpower's technological advance by administrative order. Senior officials from Commerce, State, Defense, and the National Security Council finalized the most aggressive peacetime export controls the country had ever imposed. The purpose of restricting access to advanced semiconductors was neither revenue nor symbolic punishment but capability denial—to hold China's artificial intelligence and supercomputing development near its existing level for as long as the controls could be sustained.

The resulting measures, announced on October 7, 2022, were extraordinary in scope (Allen 2022; Miller 2022). On that date BIS—the Commerce Department's Bureau of Industry and Security—added 31 Chinese firms to its *Unverified List*, a lighter-touch designation that flags companies whose bona fides U.S. inspectors have been unable to confirm rather than a trade blacklist; the marquee *Entity List* additions, including the memory champion YMTC and thirty-five other companies, came only that December. The core of the October action lay elsewhere. BIS imposed sweeping new restrictions on exporting semiconductor manufacturing equipment to China and updated the "foreign direct product rule" (FDPR) to prevent chips made anywhere in the world with American equipment from reaching designated Chinese firms. The controls effectively weaponized America's chokepoint position in the global semiconductor supply chain: no country can produce cutting-edge chips at scale without US equipment, software, and intellectual property.

The measures also reached people rather than products. Under the new "U.S. person" rule, American citizens and green card holders were prohibited from supporting the development or production of advanced chips at Chinese facilities, including facilities not otherwise subject to U.S. jurisdiction. Economic statecraft here was directed not at rival governments or firms but at individual engineers and their career choices.

Beijing's response combined public protest with a concerted domestic effort. Foreign Ministry spokespeople denounced "technological hegemony" and "economic bullying," and the Ministry of Commerce pledged to "resolutely safeguard the legitimate rights and interests of Chinese companies." The more consequential response came from policy and industry. Beijing accelerated its "dual circulation" strategy and directed substantial resources toward domestic semiconductor development despite formidable technical obstacles. It opened antitrust and data-security investigations into American firms such as Micron. And in July 2023 it imposed export controls on gallium and germanium, metals critical to semiconductors and defense applications, demonstrating that chokepoint leverage runs in both directions.

This episode illustrates the central dynamic of contemporary great power competition. The United States and China are engaged in a struggle over the leading technologies of the twenty-first century, and economic tools have become its primary instruments. Neither side launched missiles or moved troops; instead, each manipulated supply chain dependencies, restricted access to critical inputs, and used regulatory authority to reshape patterns of global commerce.
...
This is the paradox of the present era: the supply chains expected to bind nations together have instead become channels of pressure. Interdependence is, in large part, another name for mutual vulnerability, and that vulnerability is rarely symmetric. When one country controls the chokepoints in a critical network, it can use that position to extract concessions, punish adversaries, or constrain a rival's options. Interdependence does not prevent coercion so much as supply the means for it.
...
The geoeconomic lens brings several dynamics into focus. Economic power is relative rather than absolute: what matters is not a country's GDP alone but its capacity to shape global economic rules, control chokepoints in networks, and withstand pressure. China's economy is large, yet its dependence on imported semiconductors leaves it vulnerable despite that size. Economic interdependence, in turn, creates both opportunities and exposures, and states work to maximize others' dependence on them while reducing their own dependence on potential adversaries. Finally, the economic and security domains are closely intertwined, so that commercial competition in emerging technologies bears directly on military balances, intelligence capabilities, and economic resilience.
...
Economic statecraft operates across multiple domains. The **trade domain** supplies the most familiar instruments—tariffs, quotas, export controls, import bans, and preferential trade agreements; the United States uses export controls to prevent advanced technology from reaching rivals, while China uses informal trade restrictions to punish countries for political decisions it opposes (see the 2010 rare earth export restrictions after Japan detained a Chinese fishing captain, or the 2020-2021 trade restrictions on Australia following Canberra's calls for a COVID-19 investigation). Statecraft in the **financial domain** runs to sanctions, asset freezes, exclusion from payment systems (SWIFT), secondary sanctions on third parties doing business with targets, and restrictions on dollar access—the terrain of the U.S. Treasury's Office of Foreign Assets Control (OFAC), which maintains multiple sanctions programs targeting countries (Iran, North Korea, Russia), entities, and individuals (Zarate 2013; U.S. Treasury 2021). The **investment domain** turns the lens inward, to foreign direct investment screening, forced divestment, restrictions on portfolio investment, and development finance, with CFIUS (Committee on Foreign Investment in the United States) reviewing foreign acquisitions of American firms for national security implications. And the **technology domain** encompasses export controls, investment restrictions, talent restrictions, standard-setting, and technology transfer requirements—the October 2022 semiconductor controls being the exemplary case.
...
The result is partial decoupling: selective disengagement from strategically risky dependencies while maintaining broader integration. Bilateral goods trade actually climbed to a record $690 billion in 2022 (U.S. Census Bureau) before the 2025 tariff war drove it down toward $415 billion, but even at the peak the composition was shifting—advanced technology trade declining, investment scrutiny intensifying, and both sides building redundancy in critical supply chains.

The competition grew more turbulent still after 2024. The second Trump administration, back in office in January 2025, made the tariff its signature instrument but reached for a novel legal basis—invoking IEEPA, the emergency-sanctions statute, rather than the ordinary trade-remedy laws, to impose sweeping "reciprocal" tariffs in April 2025. With China the escalation ran to triple digits within weeks, U.S. duties reaching 145% and Chinese retaliation 125%—a level that approximated a mutual embargo on the goods still covered. Both of the book's margins then reasserted themselves. The breadth of the domestic pain—importers, farmers, and retailers in the United States, exporters in China—drove the two governments to the Geneva truce of May 2025, which rolled the headline rates back to 30% and 10% for ninety days. And Beijing's sharpest leverage proved to be not tariffs but the chokepoint it had spent a decade building: in October 2025 it expanded rare-earth and magnet export licensing in a move that threatened Western defense and automotive supply chains and forced Washington back to the table, producing a further pause at the Trump–Xi meeting in Busan late that month. That the IEEPA tariffs were themselves struck down by the Supreme Court in early 2026 (which held the emergency statute did not authorize them) only sharpens the lesson: the episode tracks the book's two margins almost too neatly—the hunt for a non-substitutable chokepoint, and the concentrated domestic coalitions whose pain forces recurrent de-escalation. Chapter 6 takes up the detail.

### China's Economic Power and Strategic Objectives

China brings formidable economic capabilities to this competition. It is the world's second-largest economy ($18 trillion GDP in 2023), largest trading nation ($6 trillion in goods trade annually), largest manufacturer (28% of global manufacturing output) (World Bank WDI 2024), and increasingly a technology frontier state. This economic scale creates multiple sources of leverage.

**Market access** is perhaps China's most immediate form of power. With 1.4 billion people and a growing middle class, China offers a market no major multinational can ignore. At the height of engagement-era integration this created deep corporate dependencies: China accounted for roughly a quarter of Boeing's commercial-aircraft deliveries, General Motors and its joint ventures sold more vehicles in China than in the United States, and U.S. agricultural exports to China ran into the tens of billions of dollars annually (USDA). Those particular dependencies have since been qualified—by the trade war, by Boeing's post-2019 delivery halt to Chinese carriers, and by the erosion of foreign automakers' China sales as domestic EV makers such as BYD took share—but the underlying source of leverage remains. Beijing can weaponize this access through regulations, investigations, informal pressure on consumers (calls to boycott foreign brands), or explicit restrictions. Australia experienced this in 2020-2021 when China imposed trade restrictions on barley, wine, coal, and other exports following Canberra's call for a COVID-19 investigation.

**Manufacturing dominance** in critical goods creates chokepoint leverage, though the leverage lives in specific stages rather than in headline totals. China mines roughly 70% of the world's rare earths but controls closer to 85–90% of the *processing and separation* on which magnets for defense systems, electronics, and wind turbines depend—and it is the refining chokepoint, not the mining, that matters most, since mines can be opened elsewhere far faster than separation capacity can be replicated. It produces on the order of 80% of the world's EV battery cells and dominates the solar supply chain at every stage—around 85% of module assembly and over 90% of the upstream polysilicon and wafers (USGS 2025; IEA 2025). It also supplies a large share of the active pharmaceutical ingredients (APIs) behind many essential medicines, though that dependence is often overstated and is examined more carefully in Chapter 2. This concentration means disrupting Chinese supply can cause immediate shortages in key industries—as Western countries discovered during COVID-19 when dependence on Chinese personal protective equipment and pharmaceutical inputs became apparent.
...
**Financial resources** enable global influence. With over $3 trillion in foreign exchange reserves (China's State Administration of Foreign Exchange; IMF International Financial Statistics), China can provide substantial development finance through Belt and Road Initiative, extending infrastructure loans to over 140 countries totaling an estimated $1 trillion since 2013 (AEI China Global Investment Tracker). This creates political influence and potential dependencies: recipient countries may hesitate to oppose Chinese preferences if they need continued financing or rescheduling of existing debts.
...
**Technology chokepoints** remain America's primary economic leverage. U.S. firms dominate in semiconductor design (Intel, AMD, Nvidia), cloud computing (AWS, Microsoft Azure, Google Cloud), operating systems (Microsoft, Apple), and advanced semiconductor manufacturing equipment (Applied Materials, Lam Research, KLA). In electronic design automation (EDA)—the software without which advanced chips cannot be designed—three firms hold roughly three-quarters of the global market (about 74% in 2024), but they are not "all American": Synopsys (~31%) and Cadence (~30%) are U.S. companies, while the third, Siemens EDA (~13%), has been owned by Germany's Siemens since its 2017 acquisition of Mentor Graphics (rebranded in 2021). At the leading edge the trio's combined share is higher still. Denying access to these chokepoint technologies can severely constrain rivals' technological development—the October 2022 controls leveraged exactly these positions.

**Financial centrality** provides surveillance and coercive capabilities. The dollar remains the dominant global reserve currency (58% of global reserves per IMF COFER 2024), most international transactions use dollar-denominated instruments requiring access to U.S. correspondent banks, and SWIFT cooperates closely with U.S. authorities. This enables both panopticon effects (monitoring global financial flows) and chokepoint effects (cutting designated actors from dollar-denominated finance). U.S. Treasury's sanctions authorities are unmatched in reach and effectiveness.
...
For roughly three decades after 1978, Chinese foreign-economic strategy operated under Deng Xiaoping's guidance to "hide capabilities and bide time" (韬光养晦, tāoguāng yǎnghuì) — prioritize growth, avoid confrontation, accept a peripheral role in a U.S.-designed order. Under Xi Jinping, that posture has given way to a more assertive vocabulary: "daring to struggle" (敢于斗争, gǎnyú dòuzhēng), "the East is rising and the West is declining" (东升西降, dōng shēng xī jiàng), and an explicit insistence that China will no longer accept "technology strangleholds" (卡脖子, qiǎ bózi) imposed by foreign suppliers. This is not a rhetorical shift only; it is embedded in policy documents including the 14th Five-Year Plan, the Made in China 2025 successor programs, and the 2024–2025 Central Economic Work Conference communiqués (Chinese Academy of Social Sciences 2024; State Council 2025).
...
The first domain is **trade**, encompassing tariffs, quotas, import bans, export controls, and preferential trade agreements. Trade measures are highly visible, relatively easy to implement through executive authority or legislation, but also invite retaliation and may harm domestic producers and consumers. Export controls on technology can be particularly effective when the coercing state controls chokepoint inputs, but lose effectiveness as targets develop substitutes.

The second domain, **finance**, involves sanctions, asset freezes, exclusion from payment systems (SWIFT), restrictions on correspondent banking access, limitations on dollar transactions, and sovereign debt restrictions. Financial measures leverage the centrality of dollar-denominated finance and U.S./European control of major payment systems. They can be devastating when targets depend on international finance, but overuse risks accelerating development of alternative payment systems and reserve currencies.

Third, the **investment** domain includes screening of inbound foreign direct investment (CFIUS in the US, similar mechanisms in other countries), forced divestment, restrictions on portfolio investment, limitations on acquisitions in strategic sectors, and development finance as inducement. Investment controls protect against technology transfer and strategic dependencies but may reduce capital inflows and innovation from foreign firms.

Finally, the **technology** domain covers export controls on dual-use technologies, restrictions on technical exchanges and conferences, limitations on foreign students in sensitive fields, standards-setting to exclude rivals' technologies, and requirements for technology transfer or data localization. Technology restrictions can effectively deny capabilities when chokepoints exist, but face challenges in enforcement (smuggling, third-country transshipment) and may accelerate target's indigenous development.
...
At the broadest level, **state-level** targeting applies comprehensive sanctions to an entire country's economy, as seen with Iran and North Korea. This approach generates maximum pressure but also maximum costs for the coercing state, the highest risk of humanitarian consequences, and the greatest difficulty maintaining allied support over time. A more focused approach is **sectoral** targeting, which restricts specific industries or economic sectors such as Russian energy, Chinese semiconductors, or Iranian petrochemicals. Sectoral measures are more targeted than comprehensive sanctions and easier to justify as protecting specific security interests, but sectors often have complex supply chains that make implementation challenging. Still more precise is **entity-level** targeting, which designates specific companies, banks, or organizations---for example, placing Huawei on the Entity List, excluding Russian banks from SWIFT, or adding Chinese firms to the SDN list. This surgical approach minimizes collateral damage and is easier to justify on specific national security grounds, but it requires intelligence to identify key entities and risks whack-a-mole dynamics as targets create new entities. The most granular approach is **individual-level** targeting through asset freezes and travel bans on specific officials, businesspeople, or elites, as in Magnitsky sanctions or sanctions on Russian oligarchs. These measures are highly targeted and impose low economic cost on the coercing state, making them useful for signaling and imposing personal costs on decision-makers. However, their effectiveness depends on whether targeted individuals actually influence policy and whether they maintain assets in sanctioning jurisdictions.
...
The objective of **deterrence** seeks to prevent unwanted future actions through threatened costs. It requires credibility (the threat must be believed), capability (ability to impose threatened costs), and communication (the target must understand what actions trigger sanctions). Deterrence is difficult to assess---success means nothing happens---and fails when targets value the deterred action more than avoiding sanctions costs. In contrast, **compellence** aims to force a target to take a positive action it otherwise would not, such as withdrawing from territory, releasing prisoners, or ending a weapons program. Compellence is generally harder than deterrence because it requires the target to make active concessions, often publicly. Success requires that sanctions costs exceed the target's value of the contested issue, that the target has the physical capacity to comply, and that compliance does not threaten regime survival.

A third objective, **containment**, focuses on degrading the target's capabilities to limit future threats without requiring specific behavioral changes. Export controls preventing China from accessing advanced semiconductors, for instance, aim to slow AI development regardless of policy changes. Effectiveness depends on chokepoint control---whether the target can acquire denied capabilities elsewhere or develop them indigenously. The objective of **signaling** differs from these in that it prioritizes communicating resolve, values, or alliance commitments rather than achieving specific target behavior change. Symbolic sanctions after Tiananmen Square or Magnitsky-style human rights sanctions often serve signaling functions, and success is measured by domestic and international audience reactions rather than target behavior. The most ambitious objective is **regime change**: undermining the target government to provoke leadership change or collapse. This requires comprehensive economic pressure sustained over time and has historically low success rates, as autocratic regimes often adapt to sanctions, blame external enemies, and tighten internal controls. It also carries the risk of humanitarian catastrophe if the economy collapses without regime change.
...
At the lowest end of the spectrum, **Level 1---Diplomatic Pressure** consists of public statements of concern, threats of future economic measures, and informal discussions about "consequences." These are low cost and reversible, and they maintain communication channels, but their effectiveness is limited because the target may doubt follow-through. **Level 2---Targeted Measures** escalates to sanctions on individuals or small entities, narrow export controls, and investigation announcements. These represent demonstrable action with limited economic impact, useful for signaling resolve while leaving escalation options available. **Level 3---Sectoral Restrictions** moves to industry-specific sanctions, entity list designations of major firms, and restrictions on specific technologies or financing. This level imposes meaningful economic pressure with manageable domestic costs, though it requires justification and implementation infrastructure. **Level 4---Comprehensive Sanctions** encompasses broad trade embargoes, asset freezes, financial system exclusion (SWIFT), and investment bans. The intent is severe economic pressure designed to cripple the target economy, but it carries high costs for the coercing state (lost trade, higher prices), significant allied coordination challenges, and the risk of humanitarian consequences. At the extreme, **Level 5---Economic Warfare** involves complete economic decoupling, blockades, seizure of assets, and prohibition of all transactions, approaching or including military enforcement. This level is typically only seen in wartime (WWII blockades, with current Russia sanctions approaching this level in some sectors) and requires treating the target as an existential threat.
...
The first and most intuitive criterion is **target compliance**: did the target change behavior in the desired direction? This is the primary measure but also the most contested, since determining causation is difficult when multiple factors influence target decisions. The second criterion, **capability degradation**, is particularly relevant for containment objectives: did the measures successfully limit target capabilities? Export controls succeed if they slow Chinese AI development, but fail if China quickly develops indigenous alternatives. Third, **cost imposition** asks whether measures imposed meaningful costs on the target even without behavioral change. Sanctions that devastate target economies but do not change policy may still serve strategic purposes (weakening rivals' long-term capability) or political purposes (satisfying domestic demand for action). Fourth, **sustainability** evaluates whether the measures can be maintained long enough to achieve objectives. High-intensity measures that generate rapid domestic opposition, allied defection, or target adaptation may fail even if initially effective. The fifth criterion, **collateral damage**, examines the unintended costs that measures impose on the coercing state, allies, neutrals, or civilians in target countries. Sanctions that harm humanitarian conditions, undermine long-term economic relationships, or alienate allies may be strategically counterproductive even if they impose costs on targets.
...
### Measuring Effectiveness: A Note on Inference

The criteria above describe what we would like to know about a coercive episode. Establishing it from evidence is harder, because almost every claim that economic coercion "worked" is a causal claim, and causal claims are difficult to defend with the data this field has. It is worth being explicit about the obstacles, since they bear on how much weight the cases in later chapters can carry.

The first is selection. The episodes recorded as sanctions "cases" are not a random sample of the situations in which coercion was available. States tend to impose measures where they expect some effect, or where the domestic cost of imposing them is low, and to refrain where the target is known to be immovable or the costs prohibitive. More subtly, the most effective coercion may never enter the data at all: a threat that secures compliance is resolved before any measure is imposed, and is recorded, if at all, as a quiet diplomatic outcome rather than a sanctions case (Baldwin 1985; Drezner 1999). The observed sample is thus skewed toward the harder cases that reached imposition precisely because earlier pressure had failed. A success rate estimated from imposed cases alone will tend to understate the role of economic pressure at the threat stage and overstate the futility of measures once applied.

The second obstacle is attribution. Outcomes in the world have many causes, and coercive episodes rarely occur in isolation. Apartheid South Africa faced sanctions alongside domestic insurrection, capital flight, regional war, and a steady loss of international legitimacy; Iran faced sanctions alongside sabotage, internal unrest, and shifting oil markets. Assigning a share of any outcome to the economic measure requires a counterfactual—what the target would have done in its absence—that is by construction unobserved. An account that moves from "sanctions were imposed" to "the target conceded" without specifying that counterfactual has established a sequence, not a cause.

The third is measurement. The often-cited finding that sanctions succeed in roughly a third of cases rests on coding decisions in large datasets, above all the work of Hufbauer, Schott, Elliott, and their collaborators (Hufbauer et al. 2007), and those decisions are contested. How partial concessions are scored, whether the stated objective or the operative one is used as the benchmark, and how generously the sanctioner's contribution is credited all move the headline number substantially (Pape 1997). A reported success rate is therefore a statement about a coding scheme as much as about the world, and figures produced under different schemes are not directly comparable.

These problems discipline inference rather than defeating it. The more credible evidence on effectiveness tends to share a few features. It states the counterfactual explicitly instead of leaving it implicit. It exploits variation that is plausibly unrelated to the expected outcome—a sudden, externally driven supply shock, or a restriction that falls on some firms, sectors, or regions and not others for reasons unconnected to their politics—so that those left unaffected carry information about what would otherwise have happened. And it triangulates: cross-case datasets establish broad patterns, while close reading of a single case, working from contemporaneous documents and the decisions actors actually faced, shows whether the proposed mechanism in fact operated.

This book tries to hold to that standard. Where the evidence supports a causal claim it is stated as one; where it supports only an association, or where the relevant counterfactual is genuinely unknown, the text says so. The cases are chosen partly because they offer some leverage on the counterfactual—variation across targets, sectors, or time that helps separate the effect of a measure from everything else moving at once—and readers will find more hedging here than in much of the policy literature. That is deliberate. Overconfidence about what economic pressure can accomplish has recurred across cases, often at considerable cost.
...
The framework above is descriptive. It locates a coercive measure in a domain, identifies its target, objective, and intensity, and supplies criteria for judging whether it worked. It does not, on its own, say why a given measure should be expected to succeed or fail, or how its effects evolve over time. For that the book leans on a second and simpler idea, drawn from economics rather than security studies.

Economic coercion is, at bottom, a deliberate shock to the supply of something a target needs: an input, a market, a currency, a settlement system. Treating it that way—as a supply shock with a known origin—brings two questions to the front, and the answers to them organize much of what follows. The first concerns substitution: how easily, and how quickly, can the target replace what has been denied? The second concerns distribution: on whom, precisely, do the costs fall, and can those who bear them change the policy in dispute? Call these the **substitution margin** and the **coalitional margin**. Most of the variation in whether coercion achieves its aims, and almost all of the variation in what it does over a span of years, can be traced to one or the other.

The substitution margin is where the chokepoint logic introduced earlier meets an older result in economics. Albert Hirschman observed that the power conferred by a trading relationship comes from the cost the weaker party would bear in replacing it (Hirschman 1945); a chokepoint is simply a relationship in which that replacement cost is, for the moment, very high. But replacement cost is not fixed. A long line of work on factor scarcity finds that denying an economy something it depends on raises the return to producing that thing at home, and so calls forth the very capability the denial was meant to withhold. Scarce labor induced mechanization in nineteenth-century American agriculture and industry (Habakkuk 1962; Acemoglu 2010), and the loss of one source of labor pushed firms toward substitutes for it (Hornbeck and Naidu 2014). The same mechanism runs back onto the coercer: a measure that bites hard today gives the target both the motive and the price signal to build its way out, and in doing so erodes the chokepoint that made the measure possible. This is why denial so often works in the short run and decays in the long run, and why the useful question is rarely "does this impose pain?" but "how durable is the dependence, and what is the measure teaching the target to build?"

The coalitional margin concerns politics rather than technology. A coercive measure is seldom felt evenly. It falls on particular sectors, firms, regions, and individuals, and it is their response, not the aggregate economic damage, that drives the political outcome. On the target's side, pain matters to the extent that it reaches actors who can change the contested policy: sanctions on elites whose support a regime requires operate differently from sanctions that impoverish a population the regime can ignore or blame. On the coercer's side, the same measure creates domestic losers—exporters who lose a market, manufacturers who lose an input, firms that earn a large share of revenue from the target—who lobby for exemptions, carve-outs, and sunset clauses that blunt the policy from within. Coercion reshapes coalitions on both sides of the relationship, and those coalitions feed back onto whether the measure can be sustained. My own work on a very different setting, the labor controls of apartheid South Africa, turns on this point (Wilse-Samson 2013): a sudden contraction in the supply of a key input—migrant mine labor, after Malawi and Mozambique withdrew their workers—shifted local economic interests, and with them the political alignments that had sustained the prevailing policy.

The two margins interact, since the distribution of a shock shapes both the incentive to substitute and the political response to it. A measure concentrated on a single well-resourced firm invites rapid indigenous substitution and a narrow but intense lobbying response; one diffused across a population produces neither the capacity nor the coalition to respond, and may simply be absorbed. The four dimensions describe the measure a state has chosen; the two margins help predict where that measure is likely to lead.

This is a lens, not a law. Economic coercion is also shaped by credibility, alliance politics, ideology, and accident, and no single mechanism captures all of it; the book remains pluralist in the sense set out above. But the substitution and coalitional margins recur throughout: in the semiconductor controls of Chapter 4, where denial has visibly induced the indigenization it was meant to prevent; in the financial statecraft of Chapter 7, where each use of the dollar's centrality widens the long-run incentive to escape it; and in the historical cases of Chapter 9, where the measures that failed were usually those an easy substitute defeated, and the ones that told were those that fell on a coalition unable to shift the cost elsewhere.
...
- **Tabletop Exercises** (collected in Appendix A) providing 60-90 minute scenario-based learning experiences
...
4. **Enforcement:** OFAC investigates violations, can impose civil penalties up to the greater of $377,700 per violation (the inflation-adjusted maximum effective January 2025, re-indexed annually) or twice the value of the transaction. DOJ prosecutes criminal violations (up to 20 years imprisonment, $1 million fines)
...
**Example 2: What IEEPA Does *Not* Cover — the October 2022 Semiconductor Controls**

A common misconception holds that the October 2022 China semiconductor controls were an IEEPA action. They were not, and the error is worth correcting precisely because it goes to the structure of the U.S. toolkit. Those measures were issued by the Commerce Department's Bureau of Industry and Security (BIS) under the Export Administration Regulations (EAR), whose statutory authority is the **Export Control Reform Act of 2018 (ECRA)**—not IEEPA, and not administered by OFAC. The distinction is the difference between the field's two great families of instrument:

- **IEEPA (Treasury/OFAC)** governs *sanctions*: asset freezes, transaction prohibitions, and financial exclusion tied to a declared national emergency. It operates on the SDN list and works primarily by cutting targets off from dollar-denominated finance.
- **ECRA/EAR (Commerce/BIS)** governs *export controls*: licensing requirements on the outbound flow of goods, software, and technology, enforced through the Entity List, the Unverified List, and the Foreign Direct Product Rule.

The semiconductor controls (analyzed in Chapter 4) belong entirely to the second family. IEEPA does appear elsewhere in China policy—it underpins the ICTS supply-chain rules and several of the China-related national emergencies noted below—but it was not the vehicle for the chip controls. Confusing the two authorities leads practitioners to look for compliance obligations, penalties, and off-ramps in the wrong statute.
...
- **Outcome:** Iranian oil exports dropped from ~2.5 million barrels/day to ~300,000-500,000 barrels/day at peak effectiveness (most estimates cluster around 400,000 barrels/day; TankerTrackers.com 2020; Kpler 2021); severe economic contraction; limited behavioral change on nuclear program; effectiveness declined as Iran found workarounds and Biden administration relaxed some enforcement
...
On February 24, 2022, Russia launched full-scale invasion of Ukraine. Within days, the U.S., EU, UK, and other allies coordinated an unprecedented sanctions package. On February 26, they announced exclusion of selected Russian banks from SWIFT, implemented by March 12. The initial batch covered seven banks: VTB (Russia's second-largest), Bank Otkritie, Novikombank, Promsvyazbank, Bank Rossiya, Sovcombank, and the development bank VEB. Notably, the banks that clear most of Russia's energy payments were held back to allow continued European natural gas purchases—Gazprombank, and in the first round Sberbank itself, Russia's largest bank. Sberbank was disconnected only in the EU's sixth sanctions package in June 2022, a staggering that reflected exactly the energy-dependence constraint analyzed below.
...
- US-China economic interdependence vastly exceeds US-Russia—bilateral goods trade peaking near $690 billion (2022) vs. ~$30 billion with Russia. Decoupling costs would be catastrophic for both sides.
...
- **Effectiveness requires a multi-dimensional assessment:** Economic coercion cannot be evaluated on a single criterion. Target compliance, capability degradation, cost imposition, sustainability, and collateral damage must all be weighed together. Sanctions that devastate a target economy but fail to change its behavior may still serve containment or signaling objectives.

- **Strategic empathy is essential for sound policy:** Chinese policymakers interpret U.S. export controls and financial sanctions through the lens of historical humiliation, containment, and sovereignty. Failing to account for these perceptions leads to policies that provoke escalation rather than compliance, as Beijing reads defensive measures as offensive threats to its legitimate development.

- **The CoCom and SWIFT cases illustrate contrasting logics of economic coercion:** CoCom succeeded at long-term capability degradation against the Soviet Union because allied coordination was strong and the target lacked alternative suppliers. SWIFT exclusion of Russia imposed severe immediate costs but failed to compel behavioral change, demonstrating that financial shock does not automatically translate into political compliance.

- **Legal authorities grant the U.S. executive extraordinary economic power with limited checks:** IEEPA and the National Emergencies Act enable the President to impose sweeping sanctions rapidly, but over 40 active national emergencies -- some decades old -- raise serious questions about whether emergency powers have become normalized instruments of routine foreign policy.

- **US-China competition differs fundamentally from the Cold War:** Unlike the separated economic blocs of the Cold War, the United States and China are deeply integrated, making decoupling far costlier. China's scale, technological ambition, and state-directed investment capacity make it a more formidable competitor than the Soviet Union in economic domains.

## Discussion Questions

1. The "paradox of interdependence" suggests that economic integration both promotes peace and enables coercion. Under what conditions does interdependence tip from stabilizing force to strategic vulnerability? Can policymakers design economic relationships that capture the benefits of integration while minimizing coercive risk?

2. The October 2022 semiconductor controls represented a shift from maintaining a "relative" technology lead over China to seeking "as large a lead as possible." What are the strategic risks of this shift? Could aggressive denial accelerate rather than prevent Chinese technological self-sufficiency?

3. Evaluate the claim that IEEPA's broad presidential authority is essential for effective economic statecraft. Should Congress play a larger role in authorizing economic coercion, even if this reduces speed and flexibility? How should democratic accountability apply to tools that can devastate foreign economies?

4. Comparing the CoCom (1949-1994) and Russia SWIFT exclusion (2022) cases, what factors most determine whether economic coercion achieves its objectives? Why did technology denial succeed at capability degradation while financial exclusion failed at compellence?

5. Chinese policymakers view U.S. economic statecraft as part of a containment strategy aimed at blocking China's legitimate rise. American policymakers view it as a defensive response to unfair practices and security threats. How should a policymaker account for both perspectives when designing economic coercion strategies? Is there a policy approach that addresses U.S. security concerns without confirming Chinese fears of containment?

---

> **Tabletop Exercise:** The tabletop exercise for this chapter — *Taiwan Strait Economic Coercion Crisis* — can be found in **Appendix A: Tabletop Exercises**.
