...
figures/            Data visualizations (PNG, generated by R scripts)
R/                  R scripts for figure generation
data/               Datasets and sources
exercises/          Tabletop exercises by chapter
editorial_review/   Editorial reviews
templates/          Chapter and content templates
SUMMARY.md          GitBook table of contents
book.json           GitBook configuration
styles.css          GitBook custom styles
INTRODUCTION.md     Book landing page (used by GitBook)
```
