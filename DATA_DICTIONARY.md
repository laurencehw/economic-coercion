...
| 2 | China's holdings of US Treasury securities (TIC) | **$683.5B** (year-end); declining further to ~$652B (March 2026). End-2024 ≈ $759B | Dec 2025 (latest year-end TIC); Mar 2026 monthly | U.S. Treasury, *Treasury International Capital (TIC) — Major Foreign Holders of Treasury Securities* | Custodial, not beneficial, ownership. **Not "$850B."** China is the 2nd-largest foreign holder behind Japan (~$1.1–1.2T); holdings have fallen steadily from the 2013 peak (~$1.32T). |
...
| 9 | RMB share — global reserves vs payments (stated separately) | **Reserves (COFER) ≈ 2.1%** (2.12% of allocated reserves); **SWIFT payments ≈ 2.9%** (2.88%, 6th) | Reserves 2025 Q2; payments June 2025 | IMF COFER; SWIFT RMB Tracker (July 2025) | Two different denominators — never merge. RMB reserve share has been roughly flat ~2.1–2.3%. SWIFT payment share peaked at 4.74% (Dec 2023, 4th place) and has since declined to ~2.9%. The book's 1.93% / 2.7% / 2.2% figures should be replaced with reserves 2.1% and payments 2.9%, labeled. |
...
- **IMF.** *Currency Composition of Official Foreign Exchange Reserves (COFER).* https://data.imf.org (2025 Q2 print).
